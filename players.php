...
//$sql = "select * from users where activated = 1 limit ".$start." , ".$perPage." ";
$sql = "select * from users where activated = 1";
//$total = $db->query("select * from users where activated = 1")->num_rows;
   ...
   <body>
      ...
      <table class="table text-center">
        <thead>
		 ...
		 <label class="btn btn-success" for="chooseFile"><input id="chooseFile" name="chooseFile" type="file"style="display:none;">Import XML</label>
		 <label class="btn btn-danger"><input id="submit" type="submit" style="display:none;">Submit XML</label>
              </form>
	     </div>
<?php
